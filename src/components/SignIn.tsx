...
function SignIn() {
  ...
  const styles = {
    divContainer: `${ubuntu.className} bg-amber-100 w-130 h-120 flex flex-col justify-center items-center rounded-3xl border-4 border-red-300`,
    title: "text-3xl font-bold m-3 text-center",
    form: "text-center",
    internalDivs: "flex",
    input: "border-2 border-black px-3 py-3 m-2 rounded-2xl",
  }
      ...
      <div className={styles.divContainer}>
        ...
        <form className={styles.form}>
          <div className={styles.internalDivs}>
            ...
            <Input type="text" className={styles.input} placeholder="Insert a username:" />
          </div>
          <div className={styles.internalDivs}>
            ...
            <Input type="password" className={styles.input} placeholder="Insert a password:" />
          </div>
        </form>
      </div>
    </div>
